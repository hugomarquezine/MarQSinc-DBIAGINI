...
const dadosClinica = {
    ...
    "couro-cabeludo": {
        ...
        tratamentos: [
            { nome: "MMP (Microinfusão de medicamentos)", imagem: "images/placeholder.jpg", descricao: "Técnica que insere medicamentos diretamente no couro cabeludo para tratar queda e estimular o crescimento.", beneficios: ["Ação direta no folículo", "Resultados mais rápidos", "Procedimento seguro"] },
            { nome: "Drug delivery capilar", imagem: "images/placeholder.jpg", descricao: "Uso de lasers ou microagulhamento para criar microcanais na pele e facilitar a entrega de ativos (drug delivery).", beneficios: ["Potencializa a ação de tônicos", "Estimula a circulação local", "Melhora a saúde do couro cabeludo"] },
            { nome: "LEDterapia", imagem: "images/placeholder.jpg", descricao: "Terapia com luz de LED que atua nas células, reduzindo a inflamação e estimulando o crescimento capilar.", beneficios: ["Não invasivo e indolor", "Reduz a queda", "Pode ser combinado com outros tratamentos"] }
        ]
    },
    olhos: {
        ...
        tratamentos: [
            { nome: "Ultraformer MPT", imagem: "images/placeholder.jpg", descricao: "Ultrassom microfocado que promove um efeito lifting na área das pálpebras e sobrancelhas, tratando a flacidez.", beneficios: ["Lifting de sobrancelhas", "Melhora a firmeza da pele", "Estimula o colágeno"] },
            { nome: "Preenchimento com Ácido Hialurônico", imagem: "images/placeholder.jpg", descricao: "Técnica delicada para preencher a região da olheira funda, suavizando o aspecto de cansaço.", beneficios: ["Suaviza olheiras profundas", "Resultado imediato", "Devolve o volume perdido"] },
            { nome: "Toxina Botulínica (Botox®)", imagem: "images/placeholder.jpg", descricao: "Relaxa a musculatura ao redor dos olhos para suavizar as linhas de expressão conhecidas como 'pés de galinha'.", beneficios: ["Previne rugas futuras", "Aparência mais descansada", "Aplicação rápida"] }
        ]
    },
    labios: {
        ...
        tratamentos: [
            { nome: "Preenchimento Labial", imagem: "images/placeholder.jpg", descricao: "Uso de ácido hialurônico para dar volume, contorno e hidratação aos lábios de forma natural.", beneficios: ["Volume e contorno definidos", "Hidratação profunda", "Resultados personalizados"] },
            { nome: "Toxina Botulínica (Código de Barras)", imagem: "images/placeholder.jpg", descricao: "Suaviza as linhas verticais acima do lábio superior, conhecidas como 'código de barras'.", beneficios: ["Rejuvenesce a região perioral", "Previne o aprofundamento das linhas", "Complementa o preenchimento"] }
        ]
    },
    orelhas: {
        ...
        tratamentos: [
            { nome: "Preenchimento do Lóbulo", imagem: "images/placeholder.jpg", descricao: "Com ácido hialurônico, devolve o volume e a firmeza ao lóbulo da orelha, que murcha com o tempo.", beneficios: ["Lóbulo mais jovem e preenchido", "Melhora o suporte para brincos", "Procedimento rápido"] }
        ]
    },
    pescoco: {
        ...
        tratamentos: [
            { nome: "Ultraformer MPT", imagem: "images/placeholder.jpg", descricao: "Promove um lifting não cirúrgico, tratando a flacidez e melhorando o contorno do pescoço.", beneficios: ["Efeito lifting", "Melhora a qualidade da pele", "Estimula o colágeno a longo prazo"] },
            { nome: "Toxina Botulínica (Nefertiti Lift)", imagem: "images/placeholder.jpg", descricao: "Aplicação em pontos estratégicos para relaxar a musculatura que 'puxa' o rosto para baixo, melhorando o contorno da mandíbula e do pescoço.", beneficios: ["Melhora o contorno da mandíbula", "Previne a flacidez", "Efeito rejuvenescedor"] }
        ]
    },
    colo: {
        ...
        tratamentos: [
            { nome: "Luz Intensa Pulsada", imagem: "images/placeholder.jpg", descricao: "Trata as manchas acastanhadas e avermelhadas causadas pelo sol, uniformizando o tom da pele do colo.", beneficios: ["Uniformiza o tom da pele", "Melhora vasos finos", "Estimula o colágeno"] },
            { nome: "Bioestimuladores de Colágeno", imagem: "images/placeholder.jpg", descricao: "Estimula a produção natural de colágeno para tratar a flacidez e o aspecto 'craquelado' da pele.", beneficios: ["Pele mais firme e espessa", "Reduz as rugas do sono", "Resultados duradouros"] }
        ]
    },
    papada: {
        ...
        tratamentos: [
            { nome: "Esvaziadores de Gordura (Lipo Enzimática)", imagem: "images/placeholder.jpg", descricao: "Aplicação de enzimas que quebram as células de gordura localizada na região da papada.", beneficios: ["Redução da gordura localizada", "Melhora do contorno facial", "Procedimento minimamente invasivo"] }
        ]
    },
    ...
    // ... (o bloco da 'papada' termina aqui com uma vírgula)
    ...
    bracos: {
        ...
        tratamentos: [
            { nome: "Ultraformer MPT", imagem: "images/placeholder.jpg", descricao: "Trata a flacidez na região do 'tchauzinho', estimulando o colágeno e firmando a pele.", beneficios: ["Reduz a flacidez", "Braços mais tonificados", "Resultados progressivos"] }
        ]
    },
    maos: {
        ...
        tratamentos: [
            { nome: "Preenchimento com Ácido Hialurônico", imagem: "images/placeholder.jpg", descricao: "Devolve o volume perdido no dorso das mãos, escondendo tendões e veias aparentes e rejuvenescendo a aparência.", beneficios: ["Esconde tendões e veias", "Aparência mais jovem", "Hidratação profunda"] }
        ]
    },
    abdomen: {
        ...
        tratamentos: [
            { nome: "Ultraformer MPT (Macro e Microfocado)", imagem: "images/placeholder.jpg", descricao: "Tecnologia de ultrassom que atua tanto na camada de gordura (macrofocado) quanto na pele para tratar a flacidez (microfocado).", beneficios: ["Tratamento 2 em 1: gordura e flacidez", "Melhora do contorno corporal", "Não invasivo"] }
        ]
    },
    ...
    gluteos: {
        ...
        tratamentos: [
            { nome: "Bioestimuladores para Volume e Firmeza", imagem: "images/placeholder.jpg", descricao: "Aplicação de Sculptra® ou Radiesse® para estimular o colágeno, melhorar a celulite e a firmeza, e promover um leve efeito de volume.", beneficios: ["Melhora da celulite e flacidez", "Efeito 'lifting'", "Resultados naturais"] }
        ]
    },
